                                                ...
                                                <div class="row tab-content" id="myTabContent">
                                                        <div class="col-sm-6 ">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="text" class="form-control" id="validationCustom01" name="title" placeholder="Assessment Title" required="">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input type="datetime-local" class="form-control" id="validationCustom01" name="dateTime" required="">
                                                                    <div class="valid-feedback">
                                                                        Looks good!
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <input type="number" min="15" class="form-control" id="validationCustom02" name="duration" required="">
                                                                        <div class="valid-feedback">
                                                                            Looks good!
                                                                        </div>
                                                                    </div>
