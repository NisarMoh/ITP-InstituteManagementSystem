...
<head>
    ...
    <?php require_once '../2. notice_and_forum [IT18018356]/loggedInCheck.php'; ?>
</head>

<body>

    <?php include_once '../dashboard_for_staff/nav_and_header.inc.php' ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <?php
                                            $sql = "SELECT topic_text, topic_op_id , topic_description , category_name , category_id
