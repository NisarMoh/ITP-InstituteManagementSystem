		...
		<div class="col-md-4 well card bg-light">
			...
			<form method="POST" action="save_query.php">
				...
				<div class="form-group">
					Username:<input type="text" placeholder="Username" name="username" class="form-control" oninvalid="alert('Fill the username ');" required />
				</div>
				<div class="form-group">
					Password:<input type="password" placeholder="Password" name="password" class="form-control" oninvalid="alert('Fill the password ');" required />
				</div>
