...
<body> -->
    ...
    <form action="editaction.php" method="post" name="form1">
        <table>
            ...
            <tr>
                    <th> User Name:</th>
                    <td><input type="text" id="confirm_password" value="<?php echo $conpass; ?>" name="cpass" required="" /></td>
                    <br>
                ...
                <tr>
                    <th>Password:</th>
                    <td><input type="password" id="password" value="<?php echo $pass; ?>" name="upass" required="" /></td>
                </tr>
               
                <tr>
                    <th>Qualification:</th>
                    <td><input type="text" name="qualification" value="<?php echo $quali; ?>" required="" /></td>
                </tr>
                <tr>
                    <th>Ethnic</th>
                    <td>
                        <select name="ethnic" value="<?php echo $eth; ?>">
                ...
                <tr>
                    <th>Religion:</th>
                    <td>
                        <select name="religion" value="<?php echo $reg; ?>">
                        <?php
                ...
                <tr>
                    <th>Civil Status:</th>
                    <td>
                        <select name="civilstatus" value="<?php echo $civil; ?>">
                        <?php
                ...
                <tr>
                    <th> Date Of Birth :</th>
                    <td><input type="date" name="dob" value="<?php echo $dbo; ?>" required="" /></td>
                </tr>
                <tr>
                    <th> Phone Number :</th>
                    <td><input type="text" name="phonenumber" value="<?php echo $pno; ?>" required="" /></td>
                </tr>
                <tr>
                    <th> Salary :</th>
                    <td><input type="text" name="salary" value="<?php echo $sal; ?>" required="" /></td>
                </tr>
                <tr>
                    <th> Check admin :</th>
